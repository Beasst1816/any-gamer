  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final leftTopKey = layout.leftZone.isNotEmpty ? layout.leftZone[0] : 'l_stick';
        final leftBottomKey = layout.leftZone.length > 1 ? layout.leftZone[1] : 'dpad';
        ...
        Widget buildComponent(String key) {
          ...
          switch (key) {
            ...
            case 'buttons':
              return FaceButtonCluster(isXbox: true, size: faceSize, onSignal: onSignal);
            default:
